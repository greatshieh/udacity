...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.t += 1
            # self.epsilon = 1 - 0.9 * math.exp(-1.0 * math.exp(-0.001 * (self.t - 2500)))
            # self.epsilon = 1 / (1 + 2*math.exp(0.009*(self.t-3000)))
            self.epsilon = 1 / (1 + 0.1*math.exp(0.009*(self.t-3000)))
        return None
    ...
    def build_state(self):
        ...
        state = tuple([
            waypoint, inputs['light'], inputs['left'], inputs['right'],
            inputs['oncoming']
        ])
...
def run():
    ...
    #    * alpha   - continuous value for the learning rate, default is 0
    ...
    #   optimized    - set to True to change the default log file na
    sim = Simulator(env, update_delay=0.01, log_metrics=True, optimized=True)
    ##############
    # Run the simulator
    # Flags:
    #   tolerance  - epsilon tolerance before beginning testing, default is 0.05
    #   n_test     - discrete number of testing trials to perform, default is
